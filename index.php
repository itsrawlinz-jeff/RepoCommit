    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <h1 class="my-4">Bookright Global Consultants
                    <small>Blogs</small>
                </h1>
                <?php 
                $no_posts_per_page = 5;
             ...
             ?>
                    <div class="card-footer text-muted">
                        <!-- <img src="admin/images/users/<?php echo $view_users_image; ?>" class="zoom3" alt="User Image"
                            width="50" align="left" hspace="5">
                        By <a href="author.php?auth=<?= $view_users_id; ?>"><?php echo $view_users_name; ?></a> -->
                        <br>Admin <a href="#">BookrightBLOG</a>

! function(r) {
    ...
    function i(e) {
        ...
        var n = t.form;
        "image" === (n.clk = t).type && (void 0 !== e.offsetX ? (n.clk_x = e.offsetX, n.clk_y = e.offsetY) : "function" == typeof O.fn.offset ? (a = r.offset(), n.clk_x = e.pageX - a.left, n.clk_y = e.pageY - a.top) : (n.clk_x = e.pageX - t.offsetLeft, n.clk_y = e.pageY - t.offsetTop)), setTimeout(function() {
    ...
    O.fn.attr2 = function() {
        ...
        var E, L = this,
            e = ("function" == typeof F ? F = {
                ...
                data: e,
                dataType: t
            }, "function" == typeof r && (F.success = r)) : void 0 === F && (F = {}), E = F.method || F.type || this.attr2("method"), t = (t = (t = "string" == typeof(e = F.url || this.attr2("action")) ? O.trim(e) : "") || window.location.href || "") && (t.match(/^([^#]+)/) || [])[1], r = /(MSIE|Trident)/.test(navigator.userAgent || "") && /^https/i.test(window.location.href || "") ? "javascript:false" : "about:blank", F = O.extend(!0, {
                url: t,
                success: O.ajaxSettings.success,
                type: E || O.ajaxSettings.type,
                iframeSrc: r
            }, F), {});
        if (this.trigger("form-pre-serialize", [this, F, e]), e.veto) return C("ajaxSubmit: submit vetoed via form-pre-serialize trigger"), this;
        ...
        if (F.data && (r = O.isFunction(F.data) ? F.data(a) : F.data, F.extraData = r, c = O.param(r, t)), F.beforeSubmit && !1 === F.beforeSubmit(a, this, F)) return C("ajaxSubmit: submit aborted via beforeSubmit callback"), this;
        if (this.trigger("form-submit-validate", [a, this, F, e]), e.veto) return C("ajaxSubmit: submit vetoed via form-submit-validate trigger"), this;
        var o, n, i, r = O.param(a, t),
            s = (c && (r = r ? r + "&" + c : c), "GET" === F.type.toUpperCase() ? (F.url += (0 <= F.url.indexOf("?") ? "&" : "?") + r, F.data = null) : F.data = r, []);
        F.resetForm && s.push(function() {
            ...
            for (var a = F.context || this, n = 0, o = s.length; n < o; n++) s[n].apply(a, [e, t, r || L, L])
        ...
        var u, e = 0 < O("input[type=file]:enabled", this).filter(function() {
                return "" !== O(this).val()
            }).length,
            t = "multipart/form-data",
            c = L.attr("enctype") === t || L.attr("encoding") === t,
            r = h.fileapi && h.formdata;
        C("fileAPI :" + r), !1 !== F.iframe && (F.iframe || (e || c) && !r) ? F.closeKeepAlive ? O.get(F.closeKeepAlive, function() {
            u = f(a)
        }) : u = f(a) : u = (e || c) && r ? function(e) {
        ...
        function f(e) {
            ...
            if (c.iframeTarget ? (a = (f = O(c.iframeTarget, s)).attr2("name")) ? i = a : f.attr2("name", i) : (f = O('<iframe name="' + i + '" src="' + c.iframeSrc + '" />', s)).css({
                ...
                }, (l = c.global) && 0 == O.active++ && O.event.trigger("ajaxStart"), l && O.event.trigger("ajaxSend", [p, c]), c.beforeSend && !1 === c.beforeSend.call(c.context, p, c)) return c.global && O.active--, g.reject(), g;
            ...
            function n() {
                ...
                o.setAttribute("target", i), E && !/post/i.test(E) || o.setAttribute("method", "POST"), t !== c.url && o.setAttribute("action", c.url), c.skipEncodingOverride || E && !/post/i.test(E) || L.attr({
                ...
                try {
                    ...
                    o.setAttribute("action", t), o.setAttribute("enctype", r), e ? o.setAttribute("target", e) : L.removeAttr("target"), O(a).remove()
                }
            }
            ...
            function S(t) {
                if (!p.aborted && !j) {
                    if ((T = y(d)) || (C("cannot access response document"), t = x), t === v && p) return p.abort("timeout"), void g.reject(p, "timeout");
                    if (t === x && p) return p.abort("server abort"), void g.reject(p, "error", "server abort");
        ...
        var n, o, i, s, u, c, l, f = this[0],
            d = this.attr("id"),
            p = (p = e || void 0 === f.elements ? f.getElementsByTagName("*") : f.elements) && O.makeArray(p);
        if (!(p = d && (e || /(Edge|Trident)\//.test(navigator.userAgent)) && (d = O(':input[form="' + d + '"]').get()).length ? (p || []).concat(d) : p) || !p.length) return a;
        for (n = 0, u = (p = O.isFunction(r) ? O.map(p, r) : p).length; n < u; n++)
            if ((l = (s = p[n]).name) && !s.disabled)
                if (e && f.clk && "image" === s.type) f.clk === s && (a.push({
                    name: l,
                    value: O(s).val(),
                    type: s.type
                }), a.push({
        ...
        else if (h.fileapi && "file" === s.type) {
            t && t.push(s);
            var m = s.files;
            if (m.length)
                for (o = 0; o < m.length; o++) a.push({
                    name: l,
                    value: m[o],
                    type: s.type
                });
        ...
        return !e && f.clk && (l = (r = (d = O(f.clk))[0]).name) && !r.disabled && "image" === r.type && (a.push({
            name: l,
            value: d.val()
        }), a.push({
            name: l + ".x",
